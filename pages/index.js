...
import mountain from "../public/img/mountain.jpg"; // correct path of your image 
      ...
      <div className='relative'>
        ...
        <div className='relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8  bg-gray-800/80'>
          <h1 className='text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl'>
            ...
            <span className='block text-gray-300'>on the Shimba Alps</span>
          </h1>
          <p className='mt-6 max-w-2xl mx-auto text-center text-xl'>
            House located in the hamlet of Shimba hills, at 800 meters of
